...
public class BaseClass {
	...
	public String randomnumeric() {
		String genratednumeric = RandomStringUtils.randomNumeric(10);
		return genratednumeric;
	}

	public String randomalpanumeric() {
		String genratedalpahanumeric = RandomStringUtils.randomAlphanumeric(8);
		return genratedalpahanumeric + "@gmail.com";
	}
